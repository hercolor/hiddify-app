...
class ConnectionNotifier extends _$ConnectionNotifier with AppLogger {
  ...
  void _handleCoreStatus(ConnectionStatus event) {
    ...
    if (event is Connected) {
      ...
      if (previousStatus is! Connected) _showSuccess('BflyVPN 已连接');
      ...
      if (_manualDisconnecting || !_userRequestedConnection) {
        ...
        if (previousStatus is Connected || previousStatus is Disconnecting) _showInfo('BflyVPN 已断开');
      } else if (wasRunning) {
        _scheduleAutoReconnect();
